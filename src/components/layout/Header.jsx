...
const Header = () => {
  ...
  return (
    <header className="h-16 md:h-20 lg:h-24 px-4 lg:px-8 w-full sticky top-0 z-10 bg-ecx-colors-secondary-blue text-white grid grid-cols-6 lg:flex items-center lg:justify-between">
      ...
      <button onClick={handleShowSidebar} className="lg:hidden col-span-1 flex items-center">
        <Image
          src="/icons/menu.svg"
          alt="logo"
          width={25}
      ...
      <div className="flex items-center gap-3 lg:gap-4 col-span-1 justify-end">
        <span className="hidden lg:block"><b>Track: </b>Front end Web development</span>
        <Image
          ...
          height={20}
        />
        <button className="flex items-center gap-2 transition-colors hover:bg-ecx-colors-dart/10 rounded-3xl" onClick={handleShowDropdown}>
          <Image
