...
export default function SubmissionsTable({display}) {
  return (
    <div className={`col-span-1 flex flex-col gap-6 lg:gap-8 xl:gap-10 bg-white border-[1.5px] border-[#B0AFAF] py-6 px-5 lg:px-8 ${!display && "hidden"}`}>
