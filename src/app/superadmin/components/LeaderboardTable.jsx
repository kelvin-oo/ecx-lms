...
export default function LeaderboardTable({ className = '' }) {
  ...
  const [leaderboardData, setLeaderboardData] = useState(tableData);
  ...
  return (
    <div className={`flex flex-col gap-4 relative ${className}`}>
      <div className='flex justify-between items-center'>
        <h2 className='lg:text-xl font-varela-round tracking-wide'>
          LEADERBOARD
        </h2>
      ...
      <button
        ...
        className='border border-1.5 border-ecx-colors-secondary-blue flex items-center py-0.5 lg:py-1 px-2 lg:px-4 gap-1.5 lg:gap-4 font-medium self-end text-sm lg:text-base'
      >
        See More
      </button>
